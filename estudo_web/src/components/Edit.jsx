...
export default class Edit extends Component {
    ...
    apagar() {
        axios.delete('http://localhost:3002/estudantes/delete/' + this.props.estudante.id)
            .then(
                (res) => {
    ...
    onSubmit(e) {
        ...
        axios.put('http://localhost:3002/estudantes/update/' + this.props.match.params.id, estudanteAtualiazado)
            .then(
                res => {
            ...
            <div style={{ marginTop: 10 }}>
                ...
                <form onSubmit={this.onSubmit}>
                    <div className='form-group'>
                        <label>Nome: </label>
                        <input type='text' className='form-control' value={this.state.nome} onChange={this.setNome}></input>
                    </div>
                    <div className="form-group">
                        <label>Curso: </label>
                    ...
                    <div className="form-group">
                        <input type="submit" value="Edição concluida" className="btn btn-primary" />
                    </div>
